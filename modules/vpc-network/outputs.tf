...
output "public_restricted_subnetwork_secondary_cidr_block" {
  value = google_compute_subnetwork.vpc_subnetwork_public_restricted.secondary_ip_range[0].ip_cidr_range
}

output "public_restricted_subnetwork_secondary_range_name" {
  value = google_compute_subnetwork.vpc_subnetwork_public_restricted.secondary_ip_range[0].range_name
}
